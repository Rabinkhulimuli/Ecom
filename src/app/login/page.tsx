          ...
          <div className="flex flex-col gap-2 md:gap-4 md:mt-6">
            <form className="flex flex-col gap-6 md:gap-10  " action="">
              ...
              <div className="flex md:justify-between gap-12">
                <button className="text-lg py-2 md:py-4 px-12 cursor-pointer w-fit bg-[#DB4444] text-white rounded-sm">
                  Log In
                </button>
                <button className="text-lg py-2 md:py-4 cursor-pointer w-fit text-[#DB4444] ">
                  Forget Password?
                </button>
              </div>
            </form>
            <div className="flex flex-col">
              <button className="text-lg py-2 cursor-pointer md:py-4 w-full border flex justify-center items-center gap-4 ">
                {" "}
