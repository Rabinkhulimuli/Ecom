  ...
  return (
    <div className="flex relative justify-end items-center px-8 h-12 md:px-33 bg-black text-white">
      ...
      <div className="group lg:hidden ">
        ...
        <div style={{top:`${show}%`}} className={` fixed  text-black transition-all duration-700 ease-in-out -translate-x-80 opacity-0 group-hover:opacity-100 group-hover:translate-x-0  z-20 px-6 py-8 bg-white rounded-sm  left-10 `}
