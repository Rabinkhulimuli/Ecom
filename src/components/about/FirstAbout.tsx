...
function FirstAbout() {
  return (
    <div className={`flex flex-col lg:flex-row lg:items-center justify-between gap-19`}>
      <div className="flex flex-col lg:max-w-[40%] gap-6">
        <h2 className="text-5xl lg:text-4xl xl:text-5xl font-semibold">Our Story</h2>
      ...
      <div className="w-full aspect-square ">
        <Image className="object-cover w-full h-full  bg-[#e2b5a0]" src="/nav/shopping.png" alt="shopping girl" width={830} height={600} />
      </div>
    </div>
  );
}
