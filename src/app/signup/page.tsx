      ...
      <div className='w-full flex items-center justify-center'>
        ...
        <div className='flex flex-col gap-4 md:gap-6 xl:min-w-[370px] w-full '>
            ...
            <div className='flex flex-col gap-2 md:gap-4 md:mt-6'>
                ...
                <button className='text-lg py-2 md:py-4 cursor-pointer w-full bg-[#DB4444] text-white' >Create Account</button>
            </form>
            <div className='flex flex-col'>
            <SignIn/>
                
            <p className='w-full text-center py-6 md:py-8 md:text-lg rounded-sm'><span className='opacity-70'>Already have account? </span> <Link className='ml-2 underline' href="/login">LogIn</Link></p>
