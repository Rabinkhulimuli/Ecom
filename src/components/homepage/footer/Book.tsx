...
function Book() {
  return (
    <div className='flex justify-between flex-col gap-4  md:max-w-[250px]'>
      ...
      <p className='text-lg font-semibold'>Want to make sure we&apos;re the right fit?Book a discovery call!

      </p>
        </div>
        <p>Find how you can save more and get luxury items.forever. 
</p>
        </div>
      <div className='flex flex-col gap-2 '>
      ...
      <button className='button-b-white w-fit'>
        See our plans
      </button>
      </div>
    </div>
