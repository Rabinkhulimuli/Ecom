  ...
  return (
    <div className=" flex  gap-3 lg:flex-col lg:gap-4 justify-between lg:justify-start w-full ">
      <div className="w-full  flex flex-col gap-1 sm:gap-2">
        <p className="font-semibold tracking-tight text-sm sm:text-lg text-nowrap capitalize w-full">
          Manage account
        </p>
      ...
      <div className="w-full  flex flex-col gap-1 sm:gap-2  ">
        <p className="font-semibold cursor-pointer text-sm sm:text-lg capitalize ">
          my orders
        </p>
        <div className=" drop-down">
