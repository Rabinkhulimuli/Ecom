...
function OptionMod({Icon,title,desc}:{Icon:IconType,title:string,desc:string}) {
  return (
    <div className='flex flex-col items-center w-fit gap-6'>
      ...
      <div className='flex flex-col gap-2'>
        <h2 className='font-lg lg:text-xl uppercase font-semibold text-nowrap w-full text-center'>{title}</h2>
