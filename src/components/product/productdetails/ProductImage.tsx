    ...
    <div className=" flex flex-col-reverse sm:flex-row gap-2  sm:h-[600px] w-full">
      <div className=" h-full flex sm:flex-col max-h-[600px]   gap-2">
        <div className="h-[80px] sm:h-[144px] flex-1 max-w-[190px] w-full ">
          <Image
            className="aspect-square object-cover object-right-top w-full h-full "
            src="/anime/boa.jpg"
            onClick={() => setUpdateImage("/anime/boa.jpg")}
            alt=""
            width={170}
            height={170}
          />
        ...
        <div className="h-[80px] sm:h-[144px] flex-1 max-w-[190px] w-full  ">
          <Image
            ...
            src="/anime/lufy.jpg"
            onClick={() => setUpdateImage("/anime/lufy.jpg")}
            alt=""
            width={170}
            height={170}
          />
        ...
        <div className="h-[80px] sm:h-[144px] flex-1 max-w-[190px] w-full  ">
          <Image
            ...
            src="/anime/zoro.jpg"
            onClick={() => setUpdateImage("/anime/zoro.jpg")}
            alt=""
            width={170}
            height={170}
          />
